...
class TestJSONContractValidator:
    ...
    def test_valid_contract(self):
        ...
        expected = json.dumps({"status": "success", "user_id": "usr_123", "count": 42})
        actual = json.dumps(
            {"status": "success", "user_id": "usr_456", "count": 100, "extra_field": "allowed"}
        )
    ...
    def test_missing_required_key(self):
        ...
        expected = json.dumps({"transaction_id": "tx_123", "amount": 100.00, "status": "completed"})
        actual = json.dumps(
            {
    ...
    def test_type_mismatch(self):
        ...
        expected = json.dumps({"count": 42, "active": True})
        actual = json.dumps({"count": "42", "active": True})  # String instead of int
