...
from agentops.models import AgentRunRecord, TestResult, RegressionReport
...
class TestRegressionAnalysis:
    ...
    def test_compute_pass_rate_delta_with_baseline(self):
        ...
        current_records = create_synthetic_records(
            num_records=10, pass_rate=0.5, run_id="current"
        )
        current_results = [
            TestResult(
                case_id=r.case_id,
    ...
    def test_compute_failure_type_delta(self):
        ...
        baseline_records = create_synthetic_records(
            num_records=5, pass_rate=0.0, run_id="baseline"
        )
        baseline_results = [
            TestResult(
                case_id=r.case_id,
        ...
        current_records = create_synthetic_records(
            num_records=6, pass_rate=0.0, run_id="current"
        )
        current_results = [
            TestResult(
                case_id=r.case_id,
